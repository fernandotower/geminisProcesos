...
class PhpWsdl{
	...
	public function PhpWsdl(
		...
		$this->SoapServerOptions=Array(
			...
			//se modifica para que xplicitamente sea la version 2 2
	...
	public static function CreateHtmlGeneral($data){
		...
		//modificado para que se consistente con SARA
		$res[]='<h1> Servicio Web SOAP Interfaz</h1>';
		$res[]='<p>Endpoint URI: <span class="pre">'.$server->EndPoint.'</span></p>';
		$res[]='<p>WSDL URI: <span class="pre"><a href="'.$server->EndPoint.'&readable&wsdl">'.$server->EndPoint.'&wsdl</a></span></p>';
