...
class Sql extends \Sql {
	...
	function cadena_sql($tipo, $variable = "") {
		...
		switch ($tipo) {
			...
			// consulta la posición del evento1 a partir del evento2
			...
			case "actualizarPermiso" :
				...
				$cadenaSql = " UPDATE calendario_permiso";
				$cadenaSql .= " SET permiso='" . $variable ['permiso'] . "'";
				$cadenaSql .= " WHERE id_calendario_permiso='" . $variable ['id_calendario_permiso'] . "'";
				break;
			
			case "borrarPermiso" :
				
				$cadenaSql = " DELETE FROM calendario_permiso";
				$cadenaSql .= " WHERE id_calendario_permiso='" . $variable ['id_calendario_permiso'] . "'";
				break;
		}
