...
VALUES
('evento','Evento','Acci�n que sucede durante el curso del proceso, afectan el flujo de proceso y normalmente tienen una causa (trigger) o resultado'),
('tarea','Tarea','Es el llamado a una funcion o aplicacion'),
('compuerta','Compuerta','Acci�n usada para la toma de decisiones del flujo del proceso');
...
('tareaHumana','Tarea Humana',2,'intervenci�n de un humano para su ejecuci�n'),
('tareaServicio','Tarea de Servicio',2,'llamado a un servicio realizada por el sistema sin intervenci�n humana'),
...
('tareaEnviarMensaje','Tarea de enviar mensaje',2,'designada para enviar un mensaje a un proceso o caso espec�fico, y que, una vez el mensaje haya sido enviado, la tarea es completada'),
('tareaScript','Tarea de script',2,'tarea autom�tica en la que el servidor ejecuta un script. No tienen interacci�n humana y no se conecta con ning�n servicio externo'),
('tareaTemporizador','Tarea de temporizador',2,'ejecuta un espera antes de ser completada'),
('compuertaOr','Compuerta inclusiva OR',3,'Inclusiva o multi-decisi�n. Uno o m�s caminos pueden ser activados. Uno o m�s caminos deben sincronizarse dependiendo de las actividades anteriores de la misma figura'),
