...
class EditorPermiso {
	...
	function formEditarPermiso() {
		// echo '[x] Consultar datos de calendario<br>';
		...
		$calendario = $this->miComponente->consultarCalendario ( $id_calendario );
		...
		$atributos ["leyenda"] = "Calendario: " . $calendario ['nombre_calendario'];
		echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
		echo '<br>' . $calendario ['descripcion_calendario'] . '<br><hr>Estado: ';
		...
		$atributos ["estilo"] = "jqueryui";
		$atributos ['tipoEtiqueta'] = 'inicio';
		$atributos ["leyenda"] = "Permisos: " . $calendario ['nombre_calendario'];
		echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
...
<table id="example" class="display" cellspacing="0" width="100%">
	...
	<tbody>			
			...
			foreach ( $usuarios as $clave => $valor ) {
				...
				$datos ['id_objeto'] = $calendario ['id_calendario'];
				$datos ['tipo_objeto'] = '1'; // 1. calendario 2. evento 3. plantilla 4. eventoPlantilla
...
<?
		...
		$valorCodificado .= "&tipo_objeto=1";//calendario
		$valorCodificado .= "&id_calendario=" . $_REQUEST['id_calendario'];				
