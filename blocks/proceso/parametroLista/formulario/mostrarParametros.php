...
echo 'Se debe empezar por ajustar el componente parametro para realiza busqueda';
...
<table id="example" class="display" cellspacing="0" width="100%">
	...
	<tbody>
		<tr>
			...
			<td>Elemento BPMN</td>
			<td>Elementos según la notación BPMN, tareas, compuertas, eventos
				entre otros</td>
		...
		<tr>
			...
			<td>Rol</td>
			<td>Papel que desempaña el actor en el sistema</td>
			<td align='center'>Editar</td>
		</tr>
		<tr>
			<td align='center'>3</td>
			<td>Variables</td>
			<td>Variables definidas para el prceso</td>
			<td align='center'>Editar</td>
		</tr>
		<tr>
			<td align='center'>3</td>
			<td>Variantes</td>
			<td>Variantes del proceso</td>
			<td align='center'>Editar</td>
		</tr>
	</tbody>
