...
class ConsultorCalendario {
	...
	function mostrarCalendario() {
		...
		$atributos ["leyenda"] = "Proceso Trabajos de Grado: ";
		echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
		// echo '<br>' . $resultadoCalendario ['descripcion_calendario'] . '<br><hr>Estado: ';
		switch (1) {
			case 1 :
				echo 'Proceso encargado de la administración de los trabajos de grado que pueden ser Tesis, pasantías...';
				break;
			case 2 :
				echo 'Activo';
				break;
		...
		$atributos ["estilo"] = "jqueryui";
		// $atributos ['tipoEtiqueta'] = 'inicio';
		$atributos ["leyenda"] = "Flujo de trabajo";
		echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
		$eventos = true;
		if ($eventos) {
			?>
...
<table id="example" class="display" cellspacing="0" width="100%">
	<thead>
		<tr>
			...
			<th>Responsable</th>
			<th>Rol</th>
			<th>Orden evaluación</th>
			<th>Regla transacción</th>
			<th>Regla tarea</th>
		</tr>
	</thead>
