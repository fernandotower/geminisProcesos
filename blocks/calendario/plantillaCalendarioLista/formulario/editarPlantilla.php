...
class EditorPlantilla {
	...
	function formEditarPlantilla() {
		...
		$atributos ['id'] = $esteCampo;
		$atributos ['leyenda'] = "Editar Plantilla";
		...
		$valorCodificado .= "&propietario=" . $_REQUEST ["propietario"];
		$valorCodificado .= "&id_usuario=" . $_REQUEST ['id_usuario'];
		$valorCodificado .= "&opcion=actualizarPlantilla";
		/**
...
$miRegistrador = new EditorPlantilla ( $this->lenguaje, $this->miFormulario );
$miRegistrador->mensaje ();
$miRegistrador->formEditarPlantilla ();
