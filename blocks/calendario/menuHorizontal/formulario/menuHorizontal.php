...
<div style='height: 60px; float: clear'>
	...
	<div id="toolbar" class="ui-widget-header ui-corner-all"
		...
		<a id="inicio" href="<?php echo $this->enlaceInicio()?>">Inicio</a> <a
			id="calendarios" href="<?php echo $this->enlaceInicio()?>">Calendarios</a>
		<a id="plantillas" href="<?php echo $this->enlacePlantilla()?>">Plantillas</a>
		<a id="permisos" href="<?php echo $this->enlacePermiso()?>">Permisos</a>
	</div>
...
<?php
	...
	function enlacePlantilla() {
		$url = 'index.php?data';
		$variable = "&pagina=plantillaCalendarioLista";
		$variable .= "&opcion=mostrarPlatillaCalendario"; // va a frontera
		$variable .= "&id_usuario=" . $_REQUEST ['id_usuario'];
		$variable = $this->miConfigurador->fabricaConexiones->crypto->codificar_url ( $variable, $url );
