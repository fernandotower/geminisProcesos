...
class RegistradorEvento {
    ...
    function procesarFormulario() {           	
    	...
    	$datos['tipo']=1;//$_REQUEST['tipo']; valor por defecto 1 todo es dia
    	$datos['fecha_inicio']=$_REQUEST['fecha_inicio'];
    	$datos['fecha_fin']=$_REQUEST['fecha_fin'];
    	$datos['ubicacion']=$_REQUEST['ubicacion'];
    	$datos['estado']=1;//$_REQUEST['estado'];valor por defecto 1 activo
    	...
    	$resultadoEvento=$miComponente->actualizarEvento($datosJson);
