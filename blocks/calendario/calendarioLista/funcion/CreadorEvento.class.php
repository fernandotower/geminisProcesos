...
class RegistradorEvento {
    ...
    function procesarFormulario() {           	
    	...
    	$datos['tipo']=1;//$_REQUEST['tipo']; por defecto tipo todo el dia
    	...
    	$resultadoEvento=$miComponente->crearEvento($datosJson);
    	
    	
    	Redireccionador::redireccionar("creacionEventoOK", $datos);
    	}
    	else{
